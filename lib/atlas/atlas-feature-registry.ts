...
export const ATLAS_FEATURES: readonly AtlasFeatureDefinition[] = [
  {
    ...
    startAliases: ["start shopping", "shop now", "browse marketplace"],
  ...
  },
  {
    ...
    route: "/marketplace",
    aliases: ["delivery tracking", "track delivery", "package tracking"],
    lookupAliases: [
      "track my order",
      "track my package",
      "where is my package",
  ...
  },
  {
    ...
    name: "Receipts",
    route: "/receipts",
    aliases: ["receipt", "receipts", "receipt center"],
    lookupAliases: [
      "my receipt",
      "my receipts",
      "show my receipt",
  ...
  },
  {
    ...
    name: "Account",
    route: "/account",
    aliases: ["account", "profile", "sign in", "login"],
  ...
  },
  {
    ...
    name: "Trust Center",
    route: "/trust-center",
    aliases: ["trust center", "security", "verification", "verify transaction"],
  ...
  },
  {
    ...
    name: "Help Center",
    route: "/help",
    aliases: ["help", "support", "help center", "contact support"],
  ...
  },
  {
    ...
    name: "Activity",
    route: "/dashboard",
    aliases: ["activity", "recent activity", "history", "transaction history"],
  ...
  },
  {
    ...
    name: "Wishlist",
    route: "/wishlist",
    aliases: ["wishlist", "wish list", "saved products", "saved items"],
  ...
  },
  {
    ...
    name: "Swap",
    route: "/coming-soon",
    aliases: ["swap", "token swap", "swap usdc"],
