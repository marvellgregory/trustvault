...
test("5J.1B confirmed lifecycle state alone cannot authorize the confirmation boundary", () => {
  const result = evaluateAtlasCapability(
    "transaction-confirmation",
    {
      isAuthenticated: true,
...
test("5J.1B confirmed lifecycle state alone cannot authorize execution handoff", () => {
  const result = evaluateAtlasCapability(
    "execution-handoff",
    {
      isAuthenticated: true,
