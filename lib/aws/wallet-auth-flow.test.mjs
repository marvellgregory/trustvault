...
function dependencies(overrides = {}) {
  ...
  return {
    ...
    input: {
      ...
      verifyChallenge: async (input) => { calls.push(input); return { authenticated: true, associationStatus: "VERIFIED", walletAddress: address, customerId: "tvc_11111111111111111111111111111111" }; },
...
test("rejects wallet changes and unverified or mismatched results", async () => {
  ...
  const mismatch = dependencies({ verifyChallenge: async () => ({ authenticated: true, associationStatus: "VERIFIED", walletAddress: "0x2222222222222222222222222222222222222222", customerId: "tvc_11111111111111111111111111111111" }) });
